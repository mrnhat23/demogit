...
# Đọc bảng Q từ file 'q_table.pkl'
q_table_file = os.path.abspath("C:/Users/Mr.Nhat/Desktop/q_table.pkl")
Q = joblib.load(q_table_file)
...
# Lưu bảng Q vào file 'q_table.pkl'
q_table_file = os.path.abspath("C:/Users/Mr.Nhat/Desktop/q_table.pkl")
joblib.dump(Q, q_table_file)